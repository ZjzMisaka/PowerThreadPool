...
namespace PowerThreadPool
{
    public partial class PowerPool
    {
        ...
        {
            WorkOption option = callBack == null ? WorkOption.DefaultInstance : new WorkOption();
        ...
        {
            WorkOption<TResult> option = callBack == null ? WorkOption<TResult>.DefaultInstance : new WorkOption<TResult>();
            option.Callback = callBack;
