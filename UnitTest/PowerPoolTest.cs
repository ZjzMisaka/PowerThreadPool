...
#pragma warning restore CS0162
        ...
        public void TestFireAndForget()
        {
            ...
            {
                Thread.Sleep(2000);
            }, new WorkOption { FireAndForget = true });
            Thread.Sleep(500);
        ...
        [Fact]
        public void TestFireAndForgetCallback()
        {
            _output.WriteLine($"Testing {GetType().Name}.{MethodBase.GetCurrentMethod().ReflectedType.Name}");
        ...
        [Fact]
        public void TestAsyncWorkFireAndForget()
        {
            _output.WriteLine($"Testing {GetType().Name}.{MethodBase.GetCurrentMethod().ReflectedType.Name}");
        ...
        [Fact]
        public void TestAsyncWorkFireAndForgetCallback()
        {
            _output.WriteLine($"Testing {GetType().Name}.{MethodBase.GetCurrentMethod().ReflectedType.Name}");
